...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 class="my-4" ><?php echo e(session('name')); ?> ,These are the recomended plants -<?php echo e($age); ?></h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top img-fluid" src="<?php echo e(asset('img/'.'spider.png')); ?>" alt=""></a>
        ...
        <footer class="py-5 bg-inverse">
            <div class="container">
                <p class="m-0 text-center text-white">Copyright &copy; GROVR 2017</p>
            </div>
            <!-- /.container -->
        </footer>
